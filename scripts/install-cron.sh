...
echo "  agent_adapter:   auto | openai | crewai | swarm | cursor | hermes | openclaw | manual"
echo ""
...
echo ""
echo "Optional: copy config/cron.env.example → .agents-unite/cron.env for API keys."
echo "  Cursor CLI auth does NOT work headless — use agent_adapter: llm + ollama for cron."
echo ""
